...
class address_bo extends bo
{
    ...
    {
        $sql = "UPDATE addresses SET trading_partner_id = $this->tp_id, location_id = $this->loc_id, type = '$this->type', address_line1 = '$this->add1', address_line2 = '$this->add2', pin = '$this->add2', city = '$this->city' WHERE id = '$this->id'";
